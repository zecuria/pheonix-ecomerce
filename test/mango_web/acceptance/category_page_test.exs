defmodule Mango.Acceptance.CategoryPageTest do
  use Mango.DataCase  
  use Hound.Helpers
  ...
  test "show fruits" do
    ...
    # And I expect its price to be dipslayed on screen
  ...
  test "show vegetables" do
    ## WHEN ##
    # I navigate to the vegetable page
    ...
    # And I expect Tomtato in the product displayed
    product = find_element(:css, ".product")
    product_name = find_within_element(product, :css, ".product-name") |> visible_text()
    product_price = find_within_element(product, :css, ".product-price") |> visible_text()
